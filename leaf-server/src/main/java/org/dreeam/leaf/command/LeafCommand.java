...
import org.dreeam.leaf.command.subcommands.FakePacketEntityCommand;
...
public final class LeafCommand extends Command {
    ...
    private static final LeafSubcommand FAKE_PACKET_ENTITY_SUBCOMMAND = new FakePacketEntityCommand();
    private static final Map<String, LeafSubcommand> SUBCOMMANDS = Util.make(() -> {
        ...
        commands.put(Set.of(FakePacketEntityCommand.LITERAL_ARGUMENT), FAKE_PACKET_ENTITY_SUBCOMMAND);
